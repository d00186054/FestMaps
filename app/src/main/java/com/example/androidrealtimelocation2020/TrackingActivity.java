...
import com.example.androidrealtimelocation2020.Model.MyLocation;
...
public class TrackingActivity extends FragmentActivity implements OnMapReadyCallback, ValueEventListener {
    ...
    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
        if(dataSnapshot.getValue() != null)
        {
            ...
            int width = 100;
            Bitmap b = null;
            b = BitmapFactory.decodeResource(getResources(), R.drawable.happyguy);
            ...
            Drawable myIcon = getResources().getDrawable( R.drawable.happyguy );
            mMap.addMarker(new MarkerOptions().position(userMarker).title(Common.trackingUser.getEmail()).snippet(Common.getDateFormatted(Common.convertTimeStampToDate(location.getTime()))).icon(smallMarkerIcon));
